...
//     try {
//       // Chuẩn bị dữ liệu task để lưu vào PlantsContext
//       const taskData: Omit<CareTask, 'id'> = {
//         plantId: formData.plantId,
//         type: formData.taskType,
//         date: formData.date.toISOString().split('T')[0], // Chuyển date thành string YYYY-MM-DD
...
//     } catch (error) {
//       console.error('Error saving task:', error);
//       Alert.alert('エラー', 'スケジュールの追加に失敗しました');
//     } finally {
//       setIsSubmitting(false);
//     }
//   };
...
//           </TouchableOpacity>
//           <Text style={styles.title}>スケジュール追加</Text>
//           <View style={styles.placeholder} />
//         </View>
...
//           <View style={styles.saveButtonContainer}>
//             <PrimaryButton 
//               title={isSubmitting ? "保存中..." : "スケジュールを保存"}
//               onPress={handleSave}
//               disabled={isSubmitting || plants.length === 0}
//             />
//           </View>
