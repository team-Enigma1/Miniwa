...
// //   // Mock data - sẽ thay thế bằng dữ liệu thực từ PlantsContext sau
// //   const careTasks: { [date: string]: CareTask[] } = {
// //     [selectedDate]: [
// //       {
// //         id: '1',
// //         type: 'watering',
...
// //     Object.keys(careTasks).forEach(date => {
// //       const tasks = careTasks[date];
// //       const completedCount = tasks.filter(task => task.completed).length;
// //       const totalCount = tasks.length;
...
// //   const selectedDateTasks = careTasks[selectedDate] || [];
